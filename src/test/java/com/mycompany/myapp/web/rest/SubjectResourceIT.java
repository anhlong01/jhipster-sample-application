...
class SubjectResourceIT {
    ...
    public static Subject createEntity() {
        return new Subject().subjectDescription(DEFAULT_SUBJECT_DESCRIPTION);
    }
    ...
    public static Subject createUpdatedEntity() {
        return new Subject().subjectDescription(UPDATED_SUBJECT_DESCRIPTION);
    }
    ...
    void putExistingSubject() throws Exception {
        ...
        updatedSubject.subjectDescription(UPDATED_SUBJECT_DESCRIPTION);
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.subjectDescription(UPDATED_SUBJECT_DESCRIPTION);
