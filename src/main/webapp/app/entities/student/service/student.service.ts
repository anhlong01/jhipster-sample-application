...
export class StudentService {
  ...
  getSubjectById(id: number): Observable<HttpResponse<String[]>> {
    return this.http.get<String[]>(`${this.resourceUrl}/subject/${id}`, { observe: 'response' });
  }

  getMarkById(id: number): Observable<HttpResponse<{ [key: string]: number }>> {
    return this.http.get<{ [key: string]: number }>(`${this.resourceUrl}/mark/${id}`, { observe: 'response' });
  }

  checkPassed(id: number): Observable<HttpResponse<String>> {
    return this.http.get<String>(`${this.resourceUrl}/check/${id}`, { observe: 'response', responseType: 'text' as 'json' });
  }
