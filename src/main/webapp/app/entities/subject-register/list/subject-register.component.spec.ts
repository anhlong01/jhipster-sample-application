...
import { sampleWithRequiredData } from '../subject-register.test-samples';
...
describe('SubjectRegister Management Component', () => {
  let comp: SubjectRegisterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SubjectRegisterComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.subjectRegisters()[0]).toEqual(expect.objectContaining({ id: 22971 }));
  });

  describe('trackId', () => {
    it('Should forward to subjectRegisterService', () => {
      const entity = { id: 22971 };
      jest.spyOn(service, 'getSubjectRegisterIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSubjectRegisterIdentifier).toHaveBeenCalledWith(entity);
