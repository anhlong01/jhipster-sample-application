...
import markResolve from './mark-routing-resolve.service';

describe('Mark routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: MarkService;
  let resultMark: IMark | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IMark returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        markResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultMark = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultMark).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IMark>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
